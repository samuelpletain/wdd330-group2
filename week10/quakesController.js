...
export default class QuakesController {
  ...
  async getQuakesByRadius(radius = 100) {
    ...
    this.parentElement.addEventListener('touchend', e => {
      this.getQuakeDetails(e.target.parentNode.dataset.id);
    });
  }
  async getQuakeDetails(quakeId) {
    ...
    backButton.textContent = 'Back to all the quakes'
    this.parentElement.append(backButton)
    backButton.addEventListener('click', () => this.getQuakesByRadius())
  }
}
